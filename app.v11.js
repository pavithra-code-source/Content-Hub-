document.addEventListener('DOMContentLoaded', () => {
    ...
    function handleMissedCall() {
        ...
        showToast("Call Missed. Triggering AI follow-up...", "phone-missed");
        ...
        if(missedCallsTable) {
            const newRow = `
                <tr>
                    ...
                    <td>0:00</td>
                    <td>Sent WhatsApp Greeting & Link (AI)</td>
        ...
        speakText("Call missed. AI has automatically sent a WhatsApp greeting to the caller.");
    }
    ...
    async function pollPhoneBridge() {
        try {
            ...
            if (!bridgeActive) {
                ...
                usbStatusBadge.innerHTML = '<i data-feather="usb"></i> USB: Connected';
                feather.replace();
    ...
    if(saveSettingsBtn) {
        saveSettingsBtn.addEventListener('click', () => {
            ...
            speakText(`Settings updated. AI Persona voice is now set to ${voiceGen}. Business name is ${newBizName}.`);
        });
    }
